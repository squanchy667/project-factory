...
Based on agent types from development-agents.md, pick templates from:
`project-factory/templates/claude-config/agents/`
...
### 3. Customize Each Agent
For each agent, transform the template by:
